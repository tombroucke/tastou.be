...
class ShortcodeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'tastou:shortcode {name : The shortcode name}';
    ...
    public function handle()
    {
        ...
        $viewPath = view()->getFinder()->getHints()['Tastou'][0].'/shortcodes/';
    ...
    protected function getPath($name)
    {
        ...
        return app('tastou.base_path').'/Shortcodes/'.$fileName;
    }
}
