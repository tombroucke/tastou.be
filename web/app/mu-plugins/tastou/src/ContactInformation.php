...
class ContactInformation
{
    ...
    {
        return view('Tastou::contact-information.address', [
    ...
    {
        return view('Tastou::contact-information.phone-email', [
            'phone' => $this->phone(),
            'email' => $this->email(),
        ])->toHtml();
    }
    ...
    {
        return view('Tastou::contact-information.phone', [
            'phone' => $this->phone(),
        ])->toHtml();
    }
    ...
    {
        return view('Tastou::contact-information.email', [
            'email' => $this->email(),
        ])->toHtml();
    }
}
